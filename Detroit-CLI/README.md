...
⚠️ **Aviso Importante:** Este projeto não tem como objetivo ser um clone ou uma recriação idêntica do jogo original. É um exercício académico criado para aplicar na prática conceitos de Estrutura de Dados em C++. Todo o foco do desenvolvimento está na lógica por trás das escolhas dinâmicas, e não em replicar a história comercial. Como um fã do jogo, decidi usar ele como base.
...
* **`main.cpp`:** O código refatorado. Isola o motor do jogo numa função e implementa variáveis de estado (*Flags* e *IDs* de cena) para criar um final dinamico com base na escolha passada do jogador.
...
g++ versao_dinamica.cpp -o detroit
